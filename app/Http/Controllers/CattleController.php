...
class CattleController extends Controller
{
    ...
    protected function getData(Request $request, $cattleId = 0)
    {
        $data = $request->validate([
            ...
            'father_insemination' => 'nullable',
            'status' => 'required',
            'parent_id' => 'nullable',
            'purchase_source' => 'nullable|string|min:1|max:255',
            'purchase_amount' => 'nullable|numeric|min:-2147483648|max:2147483647',
            'purchase_date' => 'nullable|date',
            'farm_entry_date' => 'nullable|date',
            'purchase_image' => ['nullable', 'file'],
            'latest_image' => ['file'],
            'middleman' => 'nullable|string|min:0|max:11',
            'species' => 'nullable|string|min:1|max:100',
            'date_of_birth' => 'nullable|date',
            'teeth' => 'nullable|numeric|min:-2147483648|max:2147483647',
            'expected_sale_price' => 'nullable|numeric|min:-2147483648|max:2147483647',
            'daily_expense' => 'nullable|numeric|min:-2147483648|max:2147483647',
            'birth_type' => 'nullable',
            'comments' => 'nullable',
        ]);
